(function () {
	if (typeof THREE === 'undefined') {
		console.warn("THREE is not defined. LightningStrike.js skipped loading.");
		return;
	}
	const BufferGeometry = THREE.BufferGeometry;
	const DynamicDrawUsage = THREE.DynamicDrawUsage || 35048;
	const Float32BufferAttribute = THREE.Float32BufferAttribute;
	const MathUtils = THREE.MathUtils;
	const Uint32BufferAttribute = THREE.Uint32BufferAttribute;
	const Vector3 = THREE.Vector3;
	const SimplexNoise = THREE.SimplexNoise;
	...
	class LightningStrike extends BufferGeometry {
		...
		init( rayParameters ) {
			...
			this.currentCreateTriangleVertices = this.createTriangleVerticesWithoutUVs;
			this.numSubrays = 0;
		...
		createDefaultSubrayCreationCallbacks() {
			...
			this.subrayConePosition = function ( segment, parentSubray, childSubray, heightFactor, sideWidthFactor, minSideWidthFactor ) {
				...
				childSubray.pos0.z = 0;
				childSubray.pos1.z = 0;
